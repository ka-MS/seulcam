...
public class CampBookingController {
	...
	public ModelAndView campList(@RequestParam(value = "memberId", required = false) String memberCheck,
			...
			@RequestParam(value = "siteNo", required = false) int siteNo, HttpServletRequest request, ModelAndView mv,
			HttpSession session) {
		try {
			// 데이트 포멧
	...
	public String bookingPayCheck(HttpServletRequest request, @ModelAttribute CampBooking cBooking,
			HttpSession session) {
		try {
			String todayfm = new SimpleDateFormat("yyyy-MM-dd").format(new Date(System.currentTimeMillis()));
			SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
	...
	public ModelAndView campBookingComplete(@RequestParam(value = "bookingNo", required = false) String bookingNo,
	...
	public ModelAndView campBookingDetail(@RequestParam(value = "bookingNo", required = false) String bookingNo,
			HttpServletRequest request, ModelAndView mv, HttpSession session) {
	...
	public ModelAndView campBookingList(@RequestParam(value = "bookingNo", required = false) String bookingNo,
			HttpServletRequest request, ModelAndView mv, HttpSession session) {
